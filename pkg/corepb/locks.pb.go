...
const file_pkg_corepb_locks_proto_rawDesc = "" +
	"\n" +
	"\x16pkg/corepb/locks.proto\x12\x19com.evrblk.grackle.corepb\x1a\x17pkg/corepb/common.proto\x1a\x1bpkg/corepb/namespaces.proto\"\x88\x02\n" +
	...
	"\n" +
	"write_lock\x18\x03 \x01(\bR\twriteLock\x12\x10\n" +
	...
	"\x12DeleteLockResponse\"\xfe\x01\n" +
	"\x10ListLocksRequest\x12k\n" +
	"\x18namespace_timestamped_id\x18\x01 \x01(\v21.com.evrblk.grackle.corepb.NamespaceTimestampedIdR\x16namespaceTimestampedId\x12\x10\n" +
	...
	"!RunLocksGarbageCollectionResponse\"\xb9\x01\n" +
	"\x1bLocksDeleteNamespaceRequest\x12k\n" +
	"\x18namespace_timestamped_id\x18\x01 \x01(\v21.com.evrblk.grackle.corepb.NamespaceTimestampedIdR\x16namespaceTimestampedId\x12\x1b\n" +
	"\trecord_id\x18\x02 \x01(\x04R\brecordId\x12\x10\n" +
	"\x03now\x18\x03 \x01(\x03R\x03now\"\x1e\n" +
	"\x1cLocksDeleteNamespaceResponse\"\xb8\x02\n" +
	"\x04Lock\x121\n" +
	...
	"\tlocked_at\x18\x03 \x01(\x03R\blockedAt\x12Q\n" +
	"\x11write_lock_holder\x18\x04 \x01(\v2%.com.evrblk.grackle.corepb.LockHolderR\x0fwriteLockHolder\x12Q\n" +
	"\x11read_lock_holders\x18\x05 \x03(\v2%.com.evrblk.grackle.corepb.LockHolderR\x0freadLockHolders\"g\n" +
	"\n" +
	"LockHolder\x12\x1d\n" +
	"\n" +
	...
	"\x14namespace_created_at\x18\x03 \x01(\x03R\x12namespaceCreatedAt\x12\x1b\n" +
	"\tlock_name\x18\x04 \x01(\tR\blockName\"\xa3\x01\n" +
	"\fLocksCounter\x12k\n" +
	"\x18namespace_timestamped_id\x18\x01 \x01(\v21.com.evrblk.grackle.corepb.NamespaceTimestampedIdR\x16namespaceTimestampedId\x12&\n" +
	"\x0fnumber_of_locks\x18\x02 \x01(\x03R\rnumberOfLocks\"\x8c\x01\n" +
	"\rLocksGCRecord\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12k\n" +
	"\x18namespace_timestamped_id\x18\x02 \x01(\v21.com.evrblk.grackle.corepb.NamespaceTimestampedIdR\x16namespaceTimestampedId\"}\n" +
	" LocksExpirationGlobalIndexRecord\x12:\n" +
	"\alock_id\x18\x01 \x01(\v2!.com.evrblk.grackle.corepb.LockIdR\x06lockId\x12\x1d\n" +
	"\n" +
	...
	"\fWRITE_LOCKED\x10\x02B&Z$github.com/evrblk/grackle/pkg/corepbb\x06proto3"
