...
const file_pkg_corepb_semaphores_proto_rawDesc = "" +
	"\n" +
	"\x1bpkg/corepb/semaphores.proto\x12\x19com.evrblk.grackle.corepb\x1a\x17pkg/corepb/common.proto\x1a\x1bpkg/corepb/namespaces.proto\"\xba\x02\n" +
	"\x16CreateSemaphoreRequest\x12k\n" +
	...
	"\tsemaphore\x18\x01 \x01(\v2$.com.evrblk.grackle.corepb.SemaphoreR\tsemaphore\"\xf1\x01\n" +
	"\x15ListSemaphoresRequest\x12k\n" +
	...
	"\tsemaphore\x18\x01 \x01(\v2$.com.evrblk.grackle.corepb.SemaphoreR\tsemaphore\"\xb4\x01\n" +
	...
	"\x03now\x18\x04 \x01(\x03R\x03now\"x\n" +
	...
	"\tsemaphore\x18\x01 \x01(\v2$.com.evrblk.grackle.corepb.SemaphoreR\tsemaphore\"\xb1\x01\n" +
	"\x16UpdateSemaphoreRequest\x12I\n" +
	"\fsemaphore_id\x18\x01 \x01(\v2&.com.evrblk.grackle.corepb.SemaphoreIdR\vsemaphoreId\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x18\n" +
	"\apermits\x18\x03 \x01(\x04R\apermits\x12\x10\n" +
	"\x03now\x18\x04 \x01(\x03R\x03now\"]\n" +
	"\x17UpdateSemaphoreResponse\x12B\n" +
	"\tsemaphore\x18\x01 \x01(\v2$.com.evrblk.grackle.corepb.SemaphoreR\tsemaphore\"c\n" +
	"\x16DeleteSemaphoreRequest\x12I\n" +
	"\fsemaphore_id\x18\x01 \x01(\v2&.com.evrblk.grackle.corepb.SemaphoreIdR\vsemaphoreId\"\x19\n" +
	"\x17DeleteSemaphoreResponse\"\xbe\x01\n" +
	...
	"\x03now\x18\x03 \x01(\x03R\x03now\"#\n" +
	"!SemaphoresDeleteNamespaceResponse\"\x96\x02\n" +
	"\tSemaphore\x126\n" +
	"\x02id\x18\x01 \x01(\v2&.com.evrblk.grackle.corepb.SemaphoreIdR\x02id\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x1d\n" +
	"\n" +
	"created_at\x18\x03 \x01(\x03R\tcreatedAt\x12\x1d\n" +
	"\n" +
	"updated_at\x18\x04 \x01(\x03R\tupdatedAt\x12\x18\n" +
	"\apermits\x18\x05 \x01(\x04R\apermits\x12W\n" +
	"\x11semaphore_holders\x18\x06 \x03(\v2*.com.evrblk.grackle.corepb.SemaphoreHolderR\x10semaphoreHolders\"l\n" +
	...
	"\x0esemaphore_name\x18\x04 \x01(\tR\rsemaphoreName\"\xe4\x01\n" +
	...
	"&RunSemaphoresGarbageCollectionResponse\"\x91\x01\n" +
	"\x12SemaphoresGCRecord\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12k\n" +
	"\x18namespace_timestamped_id\x18\x02 \x01(\v21.com.evrblk.grackle.corepb.NamespaceTimestampedIdR\x16namespaceTimestampedId\"\xb2\x01\n" +
	"\x11SemaphoresCounter\x12k\n" +
	"\x18namespace_timestamped_id\x18\x01 \x01(\v21.com.evrblk.grackle.corepb.NamespaceTimestampedIdR\x16namespaceTimestampedId\x120\n" +
	"\x14number_of_semaphores\x18\x02 \x01(\x03R\x12numberOfSemaphores\"\x91\x01\n" +
	"%SemaphoresExpirationGlobalIndexRecord\x12I\n" +
	"\fsemaphore_id\x18\x01 \x01(\v2&.com.evrblk.grackle.corepb.SemaphoreIdR\vsemaphoreId\x12\x1d\n" +
	"\n" +
