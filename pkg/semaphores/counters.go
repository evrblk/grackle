...
// countersTable stores semaphore counters indexed by namespace id
//
// Table Primary Key:
...
type countersTable struct {
	table *monsterax.BinaryTable[*corepb.SemaphoresCounter, corepb.SemaphoresCounter]
}
...
func (t *countersTable) Get(txn *store.Txn, accountId uint64, namespaceId uint32) (*corepb.SemaphoresCounter, error) {
...
func (t *countersTable) Set(txn *store.Txn, accountId uint64, namespaceId uint32, counters *corepb.SemaphoresCounter) error {
