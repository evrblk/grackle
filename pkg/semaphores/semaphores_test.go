...
func TestSemaphoresTableGet(t *testing.T) {
...
func TestSemaphoresTableGetNonExistent(t *testing.T) {
	store, err := store.NewBadgerInMemoryStore()
	require.NoError(t, err)
...
func TestSemaphoresTableGetByName(t *testing.T) {
	store, err := store.NewBadgerInMemoryStore()
	require.NoError(t, err)
...
func TestSemaphoresTableGetByNameNonExistent(t *testing.T) {
	store, err := store.NewBadgerInMemoryStore()
	require.NoError(t, err)
...
func TestSemaphoresTableCreate(t *testing.T) {
	store, err := store.NewBadgerInMemoryStore()
	require.NoError(t, err)
...
func TestSemaphoresTableCreateDuplicateName(t *testing.T) {
	store, err := store.NewBadgerInMemoryStore()
	require.NoError(t, err)
...
func TestSemaphoresTableUpdate(t *testing.T) {
	store, err := store.NewBadgerInMemoryStore()
	require.NoError(t, err)
...
func TestSemaphoresTableDelete(t *testing.T) {
	store, err := store.NewBadgerInMemoryStore()
	require.NoError(t, err)
...
func TestSemaphoresTableDeleteNonExistent(t *testing.T) {
	store, err := store.NewBadgerInMemoryStore()
	require.NoError(t, err)
...
func TestSemaphoresTableList(t *testing.T) {
	store, err := store.NewBadgerInMemoryStore()
	require.NoError(t, err)
...
func TestSemaphoresTableListWithPagination(t *testing.T) {
	store, err := store.NewBadgerInMemoryStore()
	require.NoError(t, err)
...
func TestSemaphoresTableListEmpty(t *testing.T) {
	store, err := store.NewBadgerInMemoryStore()
	require.NoError(t, err)
...
func TestSemaphoresTableMultipleNamespaces(t *testing.T) {
	store, err := store.NewBadgerInMemoryStore()
	require.NoError(t, err)
...
func TestSemaphoresTableSameNameDifferentNamespaces(t *testing.T) {
	store, err := store.NewBadgerInMemoryStore()
	require.NoError(t, err)
...
func TestSemaphoresTableGetTableKeyRanges(t *testing.T) {
...
func TestSemaphoresTableNameIndexConsistency(t *testing.T) {
	store, err := store.NewBadgerInMemoryStore()
	require.NoError(t, err)
